...
const TopVillas = () => {
  return (
    <section id="topVillas">
      ...
      <p>
      Discover our exclusive Top Villa section, where luxury meets comfort. Explore stunning properties that redefine elegance, complete with breathtaking views and premium amenities. Each villa offers a unique experience, perfect for relaxation or adventure. Unwind in style and make unforgettable memories in your dream destination. Your perfect getaway starts here!!
      </p>
